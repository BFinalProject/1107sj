...
const routes = [
    ...
    { path: '/login', component: login, name: 'login', nameKor:'로그인', useYn:"Y" },
    { path: '/test', component: test, name: 'test', nameKor:'일일업무 입력', useYn:"Y" },
    { path: '/kakaomap', component: kakaomap, name: 'kakaomap', nameKor:'맵', useYn:"Y" },
    { path: '/board', component: board, name: 'board', nameKor:'게시판메인', useYn:"Y" },
    // { path: '/board', component: board, name: 'board', nameKor:'게시판메인', useYn:"Y" },
];
